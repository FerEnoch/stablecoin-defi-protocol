...
import {Mock_ERC20_failedTransferFrom} from "./Mock_ERC20_failedTransferFrom.sol";
 ...
 *
 */
contract Mock_DSCEngine_failedTransferFrom is ReentrancyGuard {
    ///////////
    // Errors
    ///////////
    ...
    Mock_ERC20_failedTransferFrom private immutable i_dsc;
    ...
    constructor(
        ...
        i_dsc = new Mock_ERC20_failedTransferFrom(address(this));
    }
    ...
    function getDSCInstance()
        external
        view
        returns (Mock_ERC20_failedTransferFrom)
    {
        return i_dsc;
    }
}
